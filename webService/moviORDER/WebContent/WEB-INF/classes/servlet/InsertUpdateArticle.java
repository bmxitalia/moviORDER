 ...
 * Richiede la path di connessione al db dell'azienda di cui l'utente loggato è cliente e la query di insert o update dell'articolo.
 * La Servlet non fa altro che eseguire la query passata sul database passato.
 * La servlet ritorna un messaggio di fail se la modifica/inserimento non è andata a buon fine, oppure un messaggio di done se la modifica/inserimento è andata a buon fine.
 */
package servlet;
