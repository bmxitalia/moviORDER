 ...
 * 1. Creazione di un record nella tabella DocTes che indichi che è stato creato un nuovo documento;
 ...
 * La servlet ritorna un messaggio di fail se l'ordine non è andato a buon fine, oppure un messaggio di done se l'ordine è andato a buon fine.
 */
package servlet;
...
public class SendOrder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		testoMail += "<table style='border-collapse: collapse;'><tr><th style='border: 1px solid black;'>Quantità</th><th style='border: 1px solid black;'>Articolo</th><th style='border: 1px solid black;'>Descrizione</th></tr>";
		...
		ResultSet rs = dbConnect.doQuery("select max(Id_DocTes) from DocTes"); //mi prendo l'ultimo id inserito che sarà il massimo perché sono auto-incrementati
		String idDocTes = "";
		try {
			while(rs.next()) {
